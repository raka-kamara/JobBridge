...
const Feature = () => {
  ...
  return (
    <div className="my-10 bg-[#F1F8E9] py-12 rounded-2xl">
      <h1 className=" text-center my-10 font-bold text-3xl animate-pulse text-[#063840]">
        Features
      </h1>
      <div className="flex justify-center items-centertes">
        <div className="grid md:grid-cols-3 w-full md:mx-20">
          {/* First Feature */}
          <div
            ref={featureRef1}
          ...
          >
            ...
            <div className="mt-6 mb-2">
              <Fade>
                <h2 className="text-xl text-[#2E7D32] font-semibold tracking-wide">
            ...
            <p className="dark:text-gray-800 opacity-70">
              ...
              entry, or creative projects, your efforts are rewarded with
              instant coins that can be redeemed for real-world rewards.
            </p>
          </div>
          ...
          >
            ...
            <p className="dark:text-gray-800 opacity-70">
              Enjoy peace of mind with our secure payment system. Transactions
              are protected with top-tier security protocols, ensuring your
              earnings and payments are handled safely and efficiently. Trust in
              a platform where your financial transactions are always secure.
            </p>
          </div>
        </div>
      </div>
